...
<html lang="en">
    <head>
        ...
        <title>Messages - Administrator's profile</title>
    ...
    <body>
        <%
            ...
            if (request.getMethod().equals("POST")
                ...
                newpassword1 = "";
                newpassword2 = "";
                message = "<h4>Administrator succesfully Updated!</h4>";
            ...
            if (request.getMethod().equals("POST")
                ...
                if (contentType.indexOf("multipart/form-data") >= 0) {
                    ...
                    wjc.edit(user);
                    messagePhoto = "<h4>Administrator Photo succesfully Updated!</h4>";
        ...
        <ul>
            <li><a href="adminpage.jsp">Administrator Messages</a></li>
